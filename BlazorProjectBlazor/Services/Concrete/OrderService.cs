...
namespace Northwİnd.Blazor.Services.Concrete
{
    public class OrderService : IOrderService
    {
        ...
        public async Task<int> Order()
        {
            ...
            var orderResultApi = await _httpClient.PostJsonAsync<ResultModel>("http://localhost:21021/api/services/app/OrderService/Createandgetid", orderModel);
            ...
            foreach (var item in basketModel)
            {
                ...
                await _httpClient.PostJsonAsync("http://localhost:21021/api/services/app/OrderProductService/Create", orderProductModel);
            }
        ...
        {
            var resultApi= await _httpClient.GetJsonAsync<ResultModel>("http://localhost:21021/api/services/app/OrderService/GetOrdersByUserId?Id="+id);
        ...
        {
            var resultApi = await _httpClient.GetJsonAsync<ResultModel>("http://localhost:21021/api/services/app/OrderService/GetOrderDetailById?Id=" + id);
